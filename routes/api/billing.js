...
function summaryReport(corporateData, bills, gstRate, reportObject) {
  return new Promise((resolve, reject) => {
    ...
    bills.map((bill) => {
      ...
      report["Bulk Mandate Amendment-ONUS charges/Transaction"] = isNullOrUndefined(details['Bulk Mandate Ammend-ONUS.rate']) ? details['Bulk Mandate Ammend-ONUS.rate'] : 'NA';
      report["Bulk Mandate Amendment-ONUS Transactions"] = isNullOrUndefined(details['Bulk Mandate Ammend-ONUS.transactions']) ? details['Bulk Mandate Ammend-ONUS.transactions'] : 'NA';
      report["Bulk Mandate Cancellation-ONUS charges/Transaction"] = isNullOrUndefined(details['Bulk Mandate Cancel-ONUS.rate']) ? details['Bulk Mandate Cancel-ONUS.rate'] : 'NA';
      report["Bulk Mandate Cancellation-ONUS Transactions"] = isNullOrUndefined(details['Bulk Mandate Cancel-ONUS.transactions']) ? details['Bulk Mandate Cancel-ONUS.transactions'] : 'NA';
